        ...
        <form class="form-update" action="" method="post">
          ...
          <div class="row mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="unit_price" placeholder="Enter unit price" value="<?php echo $row->unit_price; ?>" min="0" step="0.01" required>
            </div>

            <div class="mb-3">
                <label class="form-label">Quantity:</label>
                <input type="number" class="form-control" name="quantity" placeholder="Enter quantity" value="<?php echo $row->quantity; ?>" min="0" required>
            </div>
